...
setwd("~/Documents/CMEECourseWork/Ecological_Evolution/data/Data") 

# List all the WAV files in the directory 
audio_directory <- "~/Documents/CMEECourseWork/Ecological_Evolution/data/Data"
...
Date_Time<-list.files(audio_directory, full.names = FALSE)
...
# Set the path to your folder containing the audio files for one site
setwd("~/Documents/CMEECourseWork/Ecological_Evolution/data/Parsonage_dawn") 

# List all the WAV files in the directory 
audio_directory2 <- "~/Documents/CMEECourseWork/Ecological_Evolution/data/Parsonage_dawn" 
...
#extract the date and time from the file name
Date_Time2<-list.files("~/Documents/CMEECourseWork/Ecological_Evolution/data/Parsonage_dawn", full.names = FALSE)
